...
Run the checks with \texttt{python3 verify\_a396798.py} in GITHUB \url{}. The manuscript
...
This argument and its verification were developed with ChatGPT assistance.
The document is a research note for independent review, not a report of
journal acceptance or an OEIS status update.
